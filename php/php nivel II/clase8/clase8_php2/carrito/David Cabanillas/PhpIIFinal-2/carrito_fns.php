<?php
function conectar(){
$cnx=mysql_connect('localhost','root','yacely') or die ('error al conectar a bd');
...
echo "<td width=100 rowspan=2><div align=center><a href=carrito_contenido.php><img src='images/view-cart.gif'><br> Ver Carrito </a></div></td>";
echo "</tr>";
...
echo "</table>";
echo "<a href='bienvenido.php'><img src='images/back.gif'></a>";
}
//************************************
...
echo "</ul>";
echo "<br>";
echo "<a href=carrito_agregar.php?isbn=$libro[isbn]><img src='images/add-to-cart.gif'><br> Agregar a Carrito</a>";
echo "<br>";
echo "</td>";
echo "</tr>";
}
...
echo "</table>";
echo "<a href='bienvenido.php'><img src='images/back.gif'></a>";
echo "<a href='javascript:history.back(1)'><img src='images/continue-shopping.gif'></a>";
//echo "<a href='carrito_guardar_cambios.php?indice=$indtxt'><img src='images/save-changes.gif'></a>";
