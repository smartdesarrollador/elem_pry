...
INSERT INTO `pelicula` (`id`,`nombrePelicula`,`generoPelicula`,`precioVenta`,`stockPelicula`) VALUES 
 (1,'Resident Evil','Terror',20,5),
 (2,'Linterna Verde','Ficcion',30,7),
 (3,'Los Pitufos','Aventura',40,15),
 (4,'Como ninios','Comedia',10,3),
 (5,'Asault','Accion',10.5,1),
 (6,'Viernes 13','Terror',20,5),
 (7,'Matrix','Ficcion',30,5),
 (8,'El Rey Leon','Aventura',40,15),
 (9,'Dura de Ligar','Comedia',10,3),
 (10,'Los Mercenarios','Accion',10.5,5);
