...
<html>
<body>
<input type="button" value="Vista PDF" onClick="window.location = 'vista_pdf.php';">
<input type="button" value="Vista EXEL" onClick="window.location = 'vista_xls.php';">
<br>
<h1>ALUMNO: Malon Reyna Jeans Enrique</h1>
</body>
</html>